...
function startConversaton(model, voice) {
  ...
  // Add selected class to voice button after UI is updated
  const voiceButton = document.getElementById(config.agent.speak.model);
  if (voiceButton) {
...
function configureSettings(model, voice) {
  ...
  if (instructionsInput) {
    instructionsInput.value = config_settings.agent.think.instructions;
  }
